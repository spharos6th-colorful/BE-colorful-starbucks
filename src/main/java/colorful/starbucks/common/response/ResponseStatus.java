...
public enum ResponseStatus {
    ...
    REDIS_SERIALIZE_FAIL(HttpStatus.INTERNAL_SERVER_ERROR, false, 9501, "Redis 직렬화 실패"),
    REDIS_DESERIALIZE_FAIL(HttpStatus.INTERNAL_SERVER_ERROR, false, 9502, "Redis 역직렬화 실패"),
