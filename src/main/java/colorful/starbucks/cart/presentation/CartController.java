...
public class CartController {
    ...
    public ApiResponse<CartProductOptionEditResponseVo> editCartProductOptions(@PathVariable String memberUuid,
        ...
        return ApiResponse.of(
                HttpStatus.OK,
                "장바구니 옵션 변경 완료했습니다.",
                productDetailService.getCartProductOption(CartProductOptionEditRequestDto.from(cartProductOptionEditRequestVo).getProductDetailCode()).toVo()
        );
    }
