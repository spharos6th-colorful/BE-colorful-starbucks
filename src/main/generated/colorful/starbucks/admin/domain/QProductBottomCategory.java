...
public class QProductBottomCategory extends EntityPathBase<ProductBottomCategory> {
    ...
    public final QProductTopCategory productTopCategory;

    public QProductBottomCategory(String variable) {
        this(ProductBottomCategory.class, forVariable(variable), INITS);
    }
    ...
    public QProductBottomCategory(PathMetadata metadata, PathInits inits) {
        this(ProductBottomCategory.class, metadata, inits);
    }

    public QProductBottomCategory(Class<? extends ProductBottomCategory> type, PathMetadata metadata, PathInits inits) {
        super(type, metadata, inits);
        this.productTopCategory = inits.isInitialized("productTopCategory") ? new QProductTopCategory(forProperty("productTopCategory")) : null;
    }
